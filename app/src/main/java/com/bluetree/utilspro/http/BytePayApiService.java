...
import com.bluetree.utilspro.MusicResponeBean;
import com.bluetree.utilspro.UserBean;
...
//    Observable<Result<MusicBean>> getSongPoerty(@Query("page") int page, @Query("count") int count);
     ...
     */
    @GET("/getJoke")
    Call<MusicResponeBean> getVideoBean(@QueryMap Map<String, String> params);
}
